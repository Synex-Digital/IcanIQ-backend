    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body me-2">
                                <h2 class="text-white font-w600">{{ $user }}</h2>
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card grd-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body me-2">
                                <h2 class="text-white font-w600"> {{ $model }} </h2>
                                <span class="text-white">Total Models</span>
                            </div>
                            <div class="d-inline-block position-relative donut-chart-sale rounded-full overflow-hidden">
                                <span class="donut1"
                                    data-peity='{ "fill": ["rgb(255, 255, 255)", "rgba(255, 255, 255, 0)"], "innerRadius": 41, "radius": 10}'>4/8</span>
                                <small class="text-primary rounded-full">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card grd-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body me-2">
                                <h2 class="text-white font-w600"> {{ $attempt }} </h2>
                                <span class="text-white">Quiz Attempts</span>
                            </div>
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card grd-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body me-2">
                                <h2 class="text-white font-w600"> {{ $panel }} </h2>
            ...
            <div class="col-xl-3 col-xxl-4">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card trending-menus" style="background: #171616 !important;">
                            <div class="card-body">
                                <img src="{{ asset('backend/logo_hd.webp') }}" width="100%">
                            </div>
                        </div>
                    </div>
                </div>
