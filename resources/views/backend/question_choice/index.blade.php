                        ...
                        <form action="{{ route('questionchoice.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" class="form-control" name="choice_text"
                                    placeholder="Write Question Here.." value="{{ $question->question_test }}" readonly>
                            </div>
                            <div class="form-group mb-3">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('modeltest.show', $question->modeltest->id) }}">{{ $question->modeltest->title }}</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">{{ $question->question_test_text }}</a></li>
            </ol>
        </div>
        @if ($errors->any())
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                            data-bs-target="#addclassmodal">+Question Choice</button>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center"><i
                                                        class="fa fa-circle text-{{ $request->is_correct != 0 ? 'success' : 'warning' }} mr-1"></i>
                                                    {{ $request->is_correct != 0 ? 'Right' : 'Wrong' }}</div>
                                            </td>
                                            <td>
                                                <div class="d-flex">
