...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="fullTable"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            Hello.
                                                            <br>Congratulation ...!!! <br>Your deposite request
                                                            confirmed.
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <a href="{{ $data['link'] }}"
                                                                style="font-size: 21px; color: #ff0000; letter-spacing: -1px; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top; text-align: right;">{{ $data['name'] }}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    <tr class="hiddenMobile">
        ...
        <tr>
        <tr class="spacer">
            <td height="50" style="background-color: #ffff"></td>
        </tr>
        <td>
            <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="fullTable"
